...
class InteractiveWizard {
  WizardConfig start() {
    ...
    print('  \x1B[36m1.\x1B[0m safe       – Analyze only, inject TODO comments');
    print('  \x1B[36m2.\x1B[0m assisted   – Generate Riverpod files alongside old code');
    print('  \x1B[36m3.\x1B[0m aggressive – Fully rewrite and replace legacy code');
  ...
  String _prompt(String message, {String? defaultValue}) {
    final defaultSuffix =
        defaultValue != null ? ' [\x1B[33m$defaultValue\x1B[0m]' : '';
